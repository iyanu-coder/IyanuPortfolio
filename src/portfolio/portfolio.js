...
const Portfolio =()=>{
    ...
    <div className="row">
            <div className="col-sm-4 d-flex justify-content-center align-item-center">
                ...
                <img className="prof" src="images/Scientific-Calculator-PNG-Pic.png" />
            ...
            <div className="col-sm-4 d-flex justify-content-center align-item-center">
                <div className="card text-dark mt-2"> 
                <img className="prof" src="images/quiz.jpg" />
       ...
       <div className="row">
            <div className="col-sm-4 d-flex justify-content-center align-item-center">
                <div className="card text-dark mt-2"> 
                <img className="prof" src="images/tictactoe.jpg" />
                    <div className="container" style={{width: "48rem"}}>
       ...
       <div className="row">
            <div className="col-sm-4 d-flex justify-content-center align-item-center">
                <div className="card text-dark mt-2"> 
                <img className="prof" src="images/shopping.png" />
                    <div className="container" style={{width: "48rem"}}>
            ...
            <div className="col-sm-4 d-flex justify-content-center align-item-center">
                <div className="card text-dark mt-2"> 
                <img className="prof" src="images/shopping2.png" />
                    <div className="container" style={{width: "48rem"}}>
            ...
            <div className="col-sm-4 d-flex justify-content-center align-item-center">
                <div className="card text-dark mt-2"> 
                <img className="prof" src="images/blog.jpg" />
                    <div className="container" style={{width: "48rem"}}>
            ...
            <div className="col-sm-4 d-flex justify-content-center align-item-center">
                <div className="card text-dark mt-2"> 
                <img className="prof" src="images/rms2.png" />
                    <div className="container" style={{width: "48rem"}}>
